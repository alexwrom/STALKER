...
type
  ...
  TControlItem = class(TLayout)
    ...
    recIcon: TImage;
    recIconBackground: TRectangle;
    recIconBackgroundTransp: TRectangle;
    layClient: TLayout;
...
begin
  ...
  recIconBackgroundTransp := TRectangle.Create(nil);
  ...
  recIconBackground := TRectangle.Create(nil);
...
begin
  ...
  if FTime >= 200 then
    ...
    begin
      if Assigned(Self.Parent as TScrollContent) and ((Self.Parent as TScrollContent).ChildrenCount > 0)then
